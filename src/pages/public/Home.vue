<template>
  <v-main class="overflow-hidden">
    <app-bar
      :background="'https://static.vecteezy.com/system/resources/previews/005/049/746/non_2x/abstract-background-banner-with-color-creative-digital-light-modern-free-vector.jpg'"
      @OnAdd="createTask"
    />
    ...
    <v-container>
      ...
      <!-- SNACKBAR TOAST -->
      <v-snackbar v-model="snackbar" color='primary' :multi-line="false" :vertical="false" :bottom="true" :left="true">
        {{ snackbar_text }}
      </v-snackbar>
    </v-container>
  </v-main>
